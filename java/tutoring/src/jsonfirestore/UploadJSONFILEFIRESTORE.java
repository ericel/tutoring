 ...
 *
 */
public class UploadJSONFILEFIRESTORE {
	 ...
	 * 
	 */
	public UploadJSONFILEFIRESTORE(String filepath, String method, String collectionname) {
	 ...
	 */
	 public static void main(String[] args) throws Exception {
	        ...
	        UploadJSONFILEFIRESTORE uploadJSONFILEFIRESTORE = new UploadJSONFILEFIRESTORE(args[0], args[1], args[2]);
